...
- if you are using a windows device, this can be done through the Microsoft store, if you are using a Mac or Linux device, you can download it from https://www.python.org/
...
Github link: https://github.com/Sir-Llama/ecm1400
